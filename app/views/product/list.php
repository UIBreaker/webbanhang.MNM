...
<ul class="list-group container mt-4"  id="product-list">
        ...
        .then(data => {
            ...
            data.forEach(product => {
                ...
                productItem.innerHTML = `
                    ...
                    <img src="/webbanhang/${product.image ? product.image : 'public/img/default.jpg'}" 
                ...
                productItem.innerHTML = `
                    ...
                    <div class="row">
                        ...
                        <a href="/webbanhang/Product/addToCart/${product.id}" class="btn btn-primary">
                            <img src="/webbanhang/public/img/add-removebg-preview.png" 
                                 alt="Thêm sản phẩm" style="height: 24px;">
                        </a>
                    </div>
                `;
                productList.appendChild(productItem);
